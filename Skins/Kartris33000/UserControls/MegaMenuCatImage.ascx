<%@ Control Language="VB" AutoEventWireup="false" EnableViewState="false" CodeFile="MegaMenuCatImage.ascx.vb"
    Inherits="MegaMenuCatImage" %>
<%@ OutputCache Duration="300" VaryByCustom="culture;user" VaryByParam="*" Shared="true" %>
<%
'-----------------------------------
