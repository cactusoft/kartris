...
Partial Class MegaMenu
    ...
    Private Sub rptTopCats_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptTopCats.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem OrElse e.Item.ItemType = ListItemType.Item Then
            ...
            Dim phdMegaMenu As PlaceHolder = e.Item.FindControl("phdMegaMenu")
            ...
            'Create the submenu
            FormatSubMenu(numCAT_ID, rptMegaMenu, phdMegaMenu)
        End If
    End Sub
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub FormatSubMenu(ByVal numSubCatID As Integer, ByVal rptMegaMenu As Repeater, ByVal phdMegaMenu As PlaceHolder)
    ...
    Private Sub rptMegaMenu_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.AlternatingItem OrElse e.Item.ItemType = ListItemType.Item Then
            ...
            imgSubCat.ImageUrl = "~/Image.ashx?strItemType=c&numMaxHeight=80&numMaxWidth=80&numItem=" & numSubCAT_ID
