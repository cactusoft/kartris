                ...
                <asp:Literal ID="litConfigType" runat="server" Text='<%# Eval("OC_DataType") %>' Visible="false" />
                          ...
                          <li><span class="Kartris-DetailsView-Name">
                            ...
                            <ajaxToolkit:FilteredTextBoxExtender ID="filNumberValue" runat="server" TargetControlID="txtValue"
                             FilterType="Numbers,Custom" ValidChars="." Enabled='<%# Eval("OC_DataType") = "n" %>' /></span></li>

                             <li><span class="Kartris-DetailsView-Name"></span>
                             <span class="Kartris-DetailsView-Value"><asp:Literal ID="litOC_Description" runat="server" Text='<%# Eval("OC_Description") %>'></asp:Literal></span></li>
                <li><br /><div class="line"></div></li>
                </ItemTemplate>
            </asp:Repeater>
