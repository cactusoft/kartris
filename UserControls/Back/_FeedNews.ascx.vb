    ...
    Protected Sub GetXML(ByVal numItem As Integer)
        ...
        If Cache.[Get](strCacheKey) Is Nothing Then
            ...
            Try
                ...
                Dim reqFeed As System.Net.HttpWebRequest = DirectCast(System.Net.WebRequest.Create("http://www.kartris.com/feed/news/?url=" & CkartrisBLL.WebShopURL), System.Net.HttpWebRequest)
