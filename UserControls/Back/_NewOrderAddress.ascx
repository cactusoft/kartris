<%@ Control Language="VB" AutoEventWireup="false" CodeFile="_NewOrderAddress.ascx.vb"
    Inherits="UserControls_Back_NewOrderAddress" %>
        ...
        <asp:PlaceHolder ID="phdAddNewAddress" runat="server">
            <div class="inputform row">
                <div class="small-9 large-10 columns">
                    <asp:DropDownList ID="ddlAddresses" runat="server" AutoPostBack="true" /></div>
            </div>
        ...
        <asp:Panel ID="pnlNewAddress" runat="server" CssClass="popup" Style="display: none" DefaultButton="btnAccept">
            <h2>
                <asp:Literal ID="litContentTextAddEditAddress" Text='<%$ Resources: Address, ContentText_AddEditAddress %>'
                    runat="server" /></h2>
            <_user:CustomerAddress ID="_UC_CustomerAddress" runat="server" ValidationGroup="Billing"
