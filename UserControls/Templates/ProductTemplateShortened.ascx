<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ProductTemplateShortened.ascx.vb" Inherits="ProductTemplateShortened" %>
    ...
    <div class="box">
        <div class="pad">
            ...
            <asp:HyperLink ID="lnkProductName" runat="server" NavigateUrl='<%# Eval("P_ID", "~/Product.aspx?ProductID={0}") %>' CssClass="details">
                <h2><asp:Literal ID="litProductName" runat="server" Text='<%# DisplayProductName() %>'></asp:Literal></h2>
