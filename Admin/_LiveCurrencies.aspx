    ...
    <div id="section_currencies">
        ...
        <asp:PlaceHolder ID="phdMainContent" runat="server">
            ...
            <span class="h1_light">
                ...
                <a class="tomeButtonLink" onclick="launchTomeHelp('https://kartris.tome.host/Content/Print/0?headId=9785')">?</a>
            </h1>
            <p>
                <asp:Literal ID="litContentTextLiveCurrencyRateText" runat="server" Text="<%$ Resources: _Currency, ContentText_LiveCurrencyRateText %>" />
            </p>
            <br />
            <br />
                ...
                <ContentTemplate>
                    <asp:PlaceHolder ID="phdCurrencies" runat="server" Visible="true">
                        ...
                        <div class="infomessage">
                            <p>
                                <asp:Literal ID="litContentTextLiveCurrencyRateNote2" runat="server"
                                    Text="International exchange rate information obtained from the <strong>European Central Bank</strong> - <a href='http://www.ecb.int'>www.ecb.int</a>"></asp:Literal>
                            </p>

                            <p>
                                <asp:Literal ID="litContentTextLiveCurrencyRateNote3" runat="server"
                                    Text="Bitcoin price from <strong>Bitpay</strong> - <a href='http://www.bitpay.com'>www.bitpay.com</a>"></asp:Literal>
                            </p>

                            <p>
                                <asp:Literal ID="litContentTextCurrencyHash" runat="server" Text="<%$ Resources: _Currency, ContentText_CurrencyHash %>" />
                            </p>
                        </div>
                    </asp:PlaceHolder>
                    <asp:PlaceHolder ID="phdCurrenciesNotAccessible" runat="server">
                        <div class="errortext">
                            <asp:Literal ID="litContentTextLiveCurrenciesNotAccessible" runat="server" Text="<%$ Resources: _Kartris, ContentText_LiveCurrenciesNotAccessible %>" />
                        </div>
                    </asp:PlaceHolder>
                </ContentTemplate>
            </asp:UpdatePanel>
