...
Public Class PowerpackBLL
    ...
    Public Sub LoadCategoryFilters(ByVal intCategoryID As Integer, ByVal Request As HttpRequest,
    ...
    Public Function CategoryHasFilters(ByVal intCategoryID As Integer) As Boolean
        Return False
    End Function

    Public Sub BoundRepeaterAttributeItem(xmlDoc As XmlDocument, arrSelectedValues() As String, ByRef itm As RepeaterItem)

    End Sub
    Public Function GetFilteredProductsByCategory(Request As HttpRequest,
                                                ByVal _CategoryID As Integer, ByVal _LanguageID As Short,
    ...
    Public Shared Function _IsSearchSuggestEnabled() As Boolean
        Return False
    End Function

    Public Function _GetFilterXMLByCategory(numCategoryID As Integer) As String
        Return "Not Enabled"
    End Function
    Public Function _GenerateFilterXML(numCategoryID As Integer, numLanguageID As Byte) As String
        Return Nothing
    End Function
    Public Function _GetFilterObjectID() As Integer
        Return 0
    End Function
    Private Function _GetAttributesAndValues(ByVal _CategoryID As Integer, ByVal _LanguageID As Short) As DataTable
        Return Nothing
    End Function
    Private Function _GetMaxPriceByCategory_s(ByVal _CategoryID As Integer, ByVal _LanguageID As Short) As Integer
        Return Nothing
    End Function
